...
Revision ID: 4bd58ba3ac29
Revises: 
Create Date: 2026-04-24 19:37:40.392678
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('idx_fu_group_membership'), table_name='fed_user_group_membership')
    op.drop_index(op.f('idx_fu_group_membership_ru'), table_name='fed_user_group_membership')
    op.drop_table('fed_user_group_membership')
    op.drop_index(op.f('idx_admin_event_time'), table_name='admin_event_entity')
    op.drop_table('admin_event_entity')
    op.drop_index(op.f('idx_fu_cnsnt_ext'), table_name='fed_user_consent')
    op.drop_index(op.f('idx_fu_consent'), table_name='fed_user_consent')
    op.drop_index(op.f('idx_fu_consent_ru'), table_name='fed_user_consent')
    op.drop_table('fed_user_consent')
    op.drop_index(op.f('idx_assoc_pol_assoc_pol_id'), table_name='associated_policy')
    op.drop_table('associated_policy')
    op.drop_index(op.f('idx_auth_exec_flow'), table_name='authentication_execution')
    op.drop_index(op.f('idx_auth_exec_realm_flow'), table_name='authentication_execution')
    op.drop_table('authentication_execution')
    op.drop_index(op.f('idx_user_consent'), table_name='user_consent')
    op.drop_table('user_consent')
    op.drop_table('identity_provider_config')
    op.drop_index(op.f('idx_realm_master_adm_cli'), table_name='realm')
    op.drop_table('realm')
    op.drop_index(op.f('idx_event_time'), table_name='event_entity')
    op.drop_table('event_entity')
    op.drop_table('client_session_role')
    op.drop_index(op.f('idx_clscope_protmap'), table_name='protocol_mapper')
    op.drop_index(op.f('idx_protocol_mapper_client'), table_name='protocol_mapper')
    op.drop_table('protocol_mapper')
    op.drop_index(op.f('idx_user_role_mapping'), table_name='user_role_mapping')
    op.drop_table('user_role_mapping')
    op.drop_table('resource_server_perm_ticket')
    op.drop_index(op.f('idx_update_time'), table_name='migration_model')
    op.drop_table('migration_model')
    op.drop_index(op.f('idx_fu_credential'), table_name='fed_user_credential')
    op.drop_index(op.f('idx_fu_credential_ru'), table_name='fed_user_credential')
    op.drop_table('fed_user_credential')
    op.drop_table('user_session_note')
    op.drop_index(op.f('idx_ident_prov_realm'), table_name='identity_provider')
    op.drop_table('identity_provider')
    op.drop_index(op.f('idx_offline_uss_by_user'), table_name='offline_user_session')
    op.drop_index(op.f('idx_offline_uss_by_usersess'), table_name='offline_user_session')
    op.drop_index(op.f('idx_offline_uss_createdon'), table_name='offline_user_session')
    op.drop_index(op.f('idx_offline_uss_preload'), table_name='offline_user_session')
    op.drop_table('offline_user_session')
    op.drop_index(op.f('idx_defcls_realm'), table_name='default_client_scope')
    op.drop_index(op.f('idx_defcls_scope'), table_name='default_client_scope')
    op.drop_table('default_client_scope')
    op.drop_table('broker_link')
    op.drop_index(op.f('idx_client_id'), table_name='client')
    op.drop_table('client')
    op.drop_table('fed_user_consent_cl_scope')
    op.drop_index(op.f('idx_res_srv_res_res_srv'), table_name='resource_server_resource')
    ...
    op.drop_index(op.f('idx_role_attribute'), table_name='role_attribute')
    op.drop_table('role_attribute')
    op.drop_index(op.f('idx_clscope_role'), table_name='client_scope_role_mapping')
    op.drop_index(op.f('idx_role_clscope'), table_name='client_scope_role_mapping')
    op.drop_table('client_scope_role_mapping')
    op.drop_index(op.f('idx_fu_attribute'), table_name='fed_user_attribute')
    op.drop_table('fed_user_attribute')
    op.drop_index(op.f('idx_usconsent_clscope'), table_name='user_consent_client_scope')
    op.drop_table('user_consent_client_scope')
    op.drop_index(op.f('idx_res_srv_scope_res_srv'), table_name='resource_server_scope')
    op.drop_table('resource_server_scope')
    op.drop_table('keycloak_group')
    op.drop_index(op.f('idx_user_email'), table_name='user_entity')
    op.drop_index(op.f('idx_user_service_account'), table_name='user_entity')
    op.drop_table('user_entity')
    op.drop_table('client_session_prot_mapper')
    op.drop_index(op.f('idx_res_policy_policy'), table_name='resource_policy')
    op.drop_table('resource_policy')
    op.drop_table('user_federation_config')
    op.drop_table('databasechangeloglock')
    op.drop_index(op.f('idx_auth_flow_realm'), table_name='authentication_flow')
    op.drop_table('authentication_flow')
    op.drop_index(op.f('idx_web_orig_client'), table_name='web_origins')
    op.drop_table('web_origins')
    op.drop_index(op.f('idx_user_attribute'), table_name='user_attribute')
    op.drop_index(op.f('idx_user_attribute_name'), table_name='user_attribute')
    op.drop_table('user_attribute')
    op.drop_index(op.f('idx_req_act_prov_realm'), table_name='required_action_provider')
    op.drop_table('required_action_provider')
    op.drop_index(op.f('idx_realm_supp_local_realm'), table_name='realm_supported_locales')
    op.drop_table('realm_supported_locales')
    op.drop_index(op.f('idx_id_prov_mapp_realm'), table_name='identity_provider_mapper')
    op.drop_table('identity_provider_mapper')
    op.drop_index(op.f('idx_client_init_acc_realm'), table_name='client_initial_access')
    op.drop_table('client_initial_access')
    op.drop_index(op.f('idx_group_role_mapp_group'), table_name='group_role_mapping')
    op.drop_table('group_role_mapping')
    op.drop_index(op.f('idx_offline_css_preload'), table_name='offline_client_session')
    op.drop_index(op.f('idx_us_sess_id_on_cl_sess'), table_name='offline_client_session')
    op.drop_table('offline_client_session')
    op.drop_index(op.f('idx_compo_config_compo'), table_name='component_config')
    op.drop_table('component_config')
    op.drop_index(op.f('idx_realm_clscope'), table_name='client_scope')
    op.drop_table('client_scope')
    op.drop_table('resource_attribute')
    op.drop_index(op.f('idx_composite'), table_name='composite_role')
    op.drop_index(op.f('idx_composite_child'), table_name='composite_role')
    op.drop_table('composite_role')
    op.drop_index(op.f('idx_realm_attr_realm'), table_name='realm_attribute')
    ...
    op.drop_index(op.f('idx_fu_required_action'), table_name='fed_user_required_action')
    op.drop_index(op.f('idx_fu_required_action_ru'), table_name='fed_user_required_action')
    op.drop_table('fed_user_required_action')
    op.drop_index(op.f('idx_realm_evt_list_realm'), table_name='realm_events_listeners')
    op.drop_table('realm_events_listeners')
    op.drop_index(op.f('idx_realm_def_grp_realm'), table_name='realm_default_groups')
    op.drop_table('realm_default_groups')
    op.drop_index(op.f('idx_user_credential'), table_name='credential')
    op.drop_table('credential')
    op.drop_index(op.f('idx_res_scope_scope'), table_name='resource_scope')
    op.drop_table('resource_scope')
    op.drop_index(op.f('idx_user_reqactions'), table_name='user_required_action')
    op.drop_table('user_required_action')
    op.drop_table('policy_config')
    op.drop_table('username_login_failure')
    op.drop_index(op.f('idx_scope_policy_policy'), table_name='scope_policy')
    op.drop_table('scope_policy')
    op.drop_index(op.f('idx_fedidentity_feduser'), table_name='federated_identity')
    op.drop_index(op.f('idx_fedidentity_user'), table_name='federated_identity')
    op.drop_table('federated_identity')
    op.drop_table('client_session_auth_status')
    op.drop_index(op.f('idx_client_session_session'), table_name='client_session')
    op.drop_table('client_session')
    op.drop_table('federated_user')
    op.drop_table('resource_uris')
    op.drop_index(op.f('idx_res_serv_pol_res_serv'), table_name='resource_server_policy')
    op.drop_table('resource_server_policy')
    op.drop_index(op.f('idx_realm_evt_types_realm'), table_name='realm_enabled_event_types')
    op.drop_table('realm_enabled_event_types')
    op.drop_index(op.f('idx_scope_mapping_role'), table_name='scope_mapping')
    op.drop_table('scope_mapping')
    op.drop_table('authenticator_config_entry')
    op.drop_index(op.f('idx_usr_fed_map_fed_prv'), table_name='user_federation_mapper')
    op.drop_index(op.f('idx_usr_fed_map_realm'), table_name='user_federation_mapper')
    op.drop_table('user_federation_mapper')
    op.drop_table('client_node_registrations')
    op.drop_index(op.f('idx_group_att_by_name_value'), table_name='group_attribute')
    op.drop_index(op.f('idx_group_attr_group'), table_name='group_attribute')
    op.drop_table('group_attribute')
    op.drop_index(op.f('idx_clscope_attrs'), table_name='client_scope_attributes')
    op.drop_table('client_scope_attributes')
    op.drop_index(op.f('idx_user_group_mapping'), table_name='user_group_membership')
    op.drop_table('user_group_membership')
    op.drop_index(op.f('idx_cl_clscope'), table_name='client_scope_client')
    op.drop_index(op.f('idx_clscope_cl'), table_name='client_scope_client')
    op.drop_table('client_scope_client')
    op.drop_index(op.f('idx_component_provider_type'), table_name='component')
    op.drop_index(op.f('idx_component_realm'), table_name='component')
    op.drop_table('component')
    op.drop_table('client_session_note')
    op.drop_table('user_session')
    op.drop_index(op.f('idx_keycloak_role_client'), table_name='keycloak_role')
    op.drop_index(op.f('idx_keycloak_role_realm'), table_name='keycloak_role')
    op.drop_table('keycloak_role')
    op.drop_table('protocol_mapper_config')
    op.drop_table('realm_required_credential')
    op.drop_index(op.f('idx_usr_fed_prv_realm'), table_name='user_federation_provider')
    op.drop_table('user_federation_provider')
    op.drop_index(op.f('idx_redir_uri_client'), table_name='redirect_uris')
    op.drop_table('redirect_uris')
    op.drop_table('resource_server')
    op.drop_index(op.f('idx_fu_role_mapping'), table_name='fed_user_role_mapping')
    op.drop_index(op.f('idx_fu_role_mapping_ru'), table_name='fed_user_role_mapping')
    op.drop_table('fed_user_role_mapping')
    op.drop_index(op.f('idx_auth_config_realm'), table_name='authenticator_config')
...
def downgrade() -> None:
    ...
    op.create_index(op.f('idx_auth_config_realm'), 'authenticator_config', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_fu_role_mapping_ru'), 'fed_user_role_mapping', ['realm_id', 'user_id'], unique=False)
    op.create_index(op.f('idx_fu_role_mapping'), 'fed_user_role_mapping', ['user_id', 'role_id'], unique=False)
    ...
    op.create_index(op.f('idx_redir_uri_client'), 'redirect_uris', ['client_id'], unique=False)
    ...
    op.create_index(op.f('idx_usr_fed_prv_realm'), 'user_federation_provider', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_keycloak_role_realm'), 'keycloak_role', ['realm'], unique=False)
    op.create_index(op.f('idx_keycloak_role_client'), 'keycloak_role', ['client'], unique=False)
    ...
    op.create_index(op.f('idx_component_realm'), 'component', ['realm_id'], unique=False)
    op.create_index(op.f('idx_component_provider_type'), 'component', ['provider_type'], unique=False)
    ...
    op.create_index(op.f('idx_clscope_cl'), 'client_scope_client', ['client_id'], unique=False)
    op.create_index(op.f('idx_cl_clscope'), 'client_scope_client', ['scope_id'], unique=False)
    ...
    op.create_index(op.f('idx_user_group_mapping'), 'user_group_membership', ['user_id'], unique=False)
    ...
    op.create_index(op.f('idx_clscope_attrs'), 'client_scope_attributes', ['scope_id'], unique=False)
    ...
    op.create_index(op.f('idx_group_attr_group'), 'group_attribute', ['group_id'], unique=False)
    op.create_index(op.f('idx_group_att_by_name_value'), 'group_attribute', ['name', sa.literal_column('(value::character varying(250))')], unique=False)
    ...
    op.create_index(op.f('idx_usr_fed_map_realm'), 'user_federation_mapper', ['realm_id'], unique=False)
    op.create_index(op.f('idx_usr_fed_map_fed_prv'), 'user_federation_mapper', ['federation_provider_id'], unique=False)
    ...
    op.create_index(op.f('idx_scope_mapping_role'), 'scope_mapping', ['role_id'], unique=False)
    ...
    op.create_index(op.f('idx_realm_evt_types_realm'), 'realm_enabled_event_types', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_res_serv_pol_res_serv'), 'resource_server_policy', ['resource_server_id'], unique=False)
    ...
    op.create_index(op.f('idx_client_session_session'), 'client_session', ['session_id'], unique=False)
    ...
    op.create_index(op.f('idx_fedidentity_user'), 'federated_identity', ['user_id'], unique=False)
    op.create_index(op.f('idx_fedidentity_feduser'), 'federated_identity', ['federated_user_id'], unique=False)
    ...
    op.create_index(op.f('idx_scope_policy_policy'), 'scope_policy', ['policy_id'], unique=False)
    ...
    op.create_index(op.f('idx_user_reqactions'), 'user_required_action', ['user_id'], unique=False)
    ...
    op.create_index(op.f('idx_res_scope_scope'), 'resource_scope', ['scope_id'], unique=False)
    ...
    op.create_index(op.f('idx_user_credential'), 'credential', ['user_id'], unique=False)
    ...
    op.create_index(op.f('idx_realm_def_grp_realm'), 'realm_default_groups', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_realm_evt_list_realm'), 'realm_events_listeners', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_fu_required_action_ru'), 'fed_user_required_action', ['realm_id', 'user_id'], unique=False)
    op.create_index(op.f('idx_fu_required_action'), 'fed_user_required_action', ['user_id', 'required_action'], unique=False)
    ...
    op.create_index(op.f('idx_realm_attr_realm'), 'realm_attribute', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_composite_child'), 'composite_role', ['child_role'], unique=False)
    op.create_index(op.f('idx_composite'), 'composite_role', ['composite'], unique=False)
    ...
    op.create_index(op.f('idx_realm_clscope'), 'client_scope', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_compo_config_compo'), 'component_config', ['component_id'], unique=False)
    ...
    op.create_index(op.f('idx_us_sess_id_on_cl_sess'), 'offline_client_session', ['user_session_id'], unique=False)
    op.create_index(op.f('idx_offline_css_preload'), 'offline_client_session', ['client_id', 'offline_flag'], unique=False)
    ...
    op.create_index(op.f('idx_group_role_mapp_group'), 'group_role_mapping', ['group_id'], unique=False)
    ...
    op.create_index(op.f('idx_client_init_acc_realm'), 'client_initial_access', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_id_prov_mapp_realm'), 'identity_provider_mapper', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_realm_supp_local_realm'), 'realm_supported_locales', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_req_act_prov_realm'), 'required_action_provider', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_user_attribute_name'), 'user_attribute', ['name', 'value'], unique=False)
    op.create_index(op.f('idx_user_attribute'), 'user_attribute', ['user_id'], unique=False)
    ...
    op.create_index(op.f('idx_web_orig_client'), 'web_origins', ['client_id'], unique=False)
    ...
    op.create_index(op.f('idx_auth_flow_realm'), 'authentication_flow', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_res_policy_policy'), 'resource_policy', ['policy_id'], unique=False)
    ...
    op.create_index(op.f('idx_user_service_account'), 'user_entity', ['realm_id', 'service_account_client_link'], unique=False)
    op.create_index(op.f('idx_user_email'), 'user_entity', ['email'], unique=False)
    ...
    op.create_index(op.f('idx_res_srv_scope_res_srv'), 'resource_server_scope', ['resource_server_id'], unique=False)
    ...
    op.create_index(op.f('idx_usconsent_clscope'), 'user_consent_client_scope', ['user_consent_id'], unique=False)
    ...
    op.create_index(op.f('idx_fu_attribute'), 'fed_user_attribute', ['user_id', 'realm_id', 'name'], unique=False)
    ...
    op.create_index(op.f('idx_role_clscope'), 'client_scope_role_mapping', ['role_id'], unique=False)
    op.create_index(op.f('idx_clscope_role'), 'client_scope_role_mapping', ['scope_id'], unique=False)
    ...
    op.create_index(op.f('idx_role_attribute'), 'role_attribute', ['role_id'], unique=False)
    ...
    op.create_index(op.f('idx_res_srv_res_res_srv'), 'resource_server_resource', ['resource_server_id'], unique=False)
    ...
    op.create_index(op.f('idx_client_id'), 'client', ['client_id'], unique=False)
    ...
    op.create_index(op.f('idx_defcls_scope'), 'default_client_scope', ['scope_id'], unique=False)
    op.create_index(op.f('idx_defcls_realm'), 'default_client_scope', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_offline_uss_preload'), 'offline_user_session', ['offline_flag', 'created_on', 'user_session_id'], unique=False)
    op.create_index(op.f('idx_offline_uss_createdon'), 'offline_user_session', ['created_on'], unique=False)
    op.create_index(op.f('idx_offline_uss_by_usersess'), 'offline_user_session', ['realm_id', 'offline_flag', 'user_session_id'], unique=False)
    op.create_index(op.f('idx_offline_uss_by_user'), 'offline_user_session', ['user_id', 'realm_id', 'offline_flag'], unique=False)
    ...
    op.create_index(op.f('idx_ident_prov_realm'), 'identity_provider', ['realm_id'], unique=False)
    ...
    op.create_index(op.f('idx_fu_credential_ru'), 'fed_user_credential', ['realm_id', 'user_id'], unique=False)
    op.create_index(op.f('idx_fu_credential'), 'fed_user_credential', ['user_id', 'type'], unique=False)
    ...
    op.create_index(op.f('idx_update_time'), 'migration_model', ['update_time'], unique=False)
    ...
    op.create_index(op.f('idx_user_role_mapping'), 'user_role_mapping', ['user_id'], unique=False)
    ...
    op.create_index(op.f('idx_protocol_mapper_client'), 'protocol_mapper', ['client_id'], unique=False)
    op.create_index(op.f('idx_clscope_protmap'), 'protocol_mapper', ['client_scope_id'], unique=False)
    ...
    op.create_index(op.f('idx_event_time'), 'event_entity', ['realm_id', 'event_time'], unique=False)
    ...
    op.create_index(op.f('idx_realm_master_adm_cli'), 'realm', ['master_admin_client'], unique=False)
    ...
    op.create_index(op.f('idx_user_consent'), 'user_consent', ['user_id'], unique=False)
    ...
    op.create_index(op.f('idx_auth_exec_realm_flow'), 'authentication_execution', ['realm_id', 'flow_id'], unique=False)
    op.create_index(op.f('idx_auth_exec_flow'), 'authentication_execution', ['flow_id'], unique=False)
    ...
    op.create_index(op.f('idx_assoc_pol_assoc_pol_id'), 'associated_policy', ['associated_policy_id'], unique=False)
    ...
    op.create_index(op.f('idx_fu_consent_ru'), 'fed_user_consent', ['realm_id', 'user_id'], unique=False)
    op.create_index(op.f('idx_fu_consent'), 'fed_user_consent', ['user_id', 'client_id'], unique=False)
    op.create_index(op.f('idx_fu_cnsnt_ext'), 'fed_user_consent', ['user_id', 'client_storage_provider', 'external_client_id'], unique=False)
    ...
    op.create_index(op.f('idx_admin_event_time'), 'admin_event_entity', ['realm_id', 'admin_event_time'], unique=False)
    ...
    op.create_index(op.f('idx_fu_group_membership_ru'), 'fed_user_group_membership', ['realm_id', 'user_id'], unique=False)
    op.create_index(op.f('idx_fu_group_membership'), 'fed_user_group_membership', ['user_id', 'group_id'], unique=False)
